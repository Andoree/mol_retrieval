...
#SBATCH --error=/home/etutubalina/graph_entity_linking/text_kb_pretraining/mol_retrieval/logs/train_eval_pipeline/train_eval_roberta_zinc_480m_multilabel.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/text_kb_pretraining/mol_retrieval/logs/train_eval_pipeline/train_eval_roberta_zinc_480m_multilabel.txt       # Файл для вывода результатов
...
MODEL_VERBOSE=roberta_zinc_480m
MODEL=/home/etutubalina/graph_entity_linking/huggingface_models/entropy/roberta_zinc_480m
