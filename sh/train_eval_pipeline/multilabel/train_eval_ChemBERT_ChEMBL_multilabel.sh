...
#SBATCH --error=/home/etutubalina/graph_entity_linking/text_kb_pretraining/mol_retrieval/logs/train_eval_pipeline/train_eval_ChemBERT_ChEMBL_multilabel.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/text_kb_pretraining/mol_retrieval/logs/train_eval_pipeline/train_eval_ChemBERT_ChEMBL_multilabel.txt       # Файл для вывода результатов
...
MODEL_VERBOSE=ChemBERT_ChEMBL
MODEL=/home/etutubalina/graph_entity_linking/huggingface_models/jonghyunlee/ChemBERT_ChEMBL_pretrained/
...
TASK_NAMES=("multilabel_classification")
