...
#SBATCH --error=/home/etutubalina/graph_entity_linking/text_kb_pretraining/mol_retrieval/logs/retrieval/molecule_retrieval_Zinc-GPT.err        # Файл для вывода ошибок
#SBATCH --output=/home/etutubalina/graph_entity_linking/text_kb_pretraining/mol_retrieval/logs/retrieval/molecule_retrieval_Zinc-GPT.txt       # Файл для вывода результатов
...
MODEL_VERBOSE=Zinc-GPT
MODEL=/home/etutubalina/graph_entity_linking/huggingface_models/entropy/gpt2_zinc_87m
